...
const SignUp = () => {
    ...
    const onSubmit = (data) => {
        ...
        dispatch(
            setNewUser({ newUser, cb: () => navigate(from, { replace: true }) })
        );
    };
        ...
        <div className={styles.signUp__wrapper}>
            <form className={styles.signUp} onSubmit={handleSubmit(onSubmit)}>
                ...
                <label className={styles.signUp__label}>
                    ...
                    <input
                        ...
                        {...register("username", {
                            ...
                            minLength: {
                                value: 3,
                                message:
                                    "You can use a minimum of 3 characters",
                            },
                            pattern: {
                                value: /^[a-z][a-z0-9]*$/,
                                message:
                    ...
                    {userError ? (
                        <p>
                            {userError.username ? getValues("username") : null}{" "}
                            {userError.username}
                        </p>
                    ) : null}
                </label>
                ...
                <label className={styles.signUp__label}>
                    ...
                    {userError ? (
                        <p>
                            {userError.email ? getValues("email") : null}{" "}
                            {userError.email}
                        </p>
                    ) : null}
                </label>
                    ...
                    <input
                        ...
                        {...register("password", {
                            ...
                            minLength: {
                                value: 6,
                                message:
                                    "You can use a minimum of 6 characters",
                            },
                        })}
                    />
